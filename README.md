...
<sub><b style="font-size:15px">A passionate Cloud Engineer || DevOps Engineer || AWS Community Builder || SRE Enginner<sub><b style="font-size:15px">

Email Me 👉 ✉️ <sub><b style="font-size:15px">badhon@theclinicall.com<sub><b style="font-size:15px"> For Collaboration/Project or Anything Else. 😊😊
...
<sub><b style="font-size:15px">LANGUAGES</b></sub> <br>
...
<sub><b style="font-size:15px">Hosting/SaaS</b></sub> <br>
...
<sub><b style="font-size:15px">FRAMEWORKS, PLATFORMS & LIBRARIES</b></sub> <br>
