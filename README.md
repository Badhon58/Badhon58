...
<sub><b style="font-size:25px">A passionate Cloud Engineer || DevOps Engineer || AWS Community Builder || SRE Enginner<sub><b style="font-size:25px">

Email Me 👉 ✉️ <sub><b style="font-size:25px">badhon@theclinicall.com<sub><b style="font-size:25px"> For Collaboration/Project or Anything Else. 😊😊
...
<sub><b style="font-size:25px">LANGUAGES</b></sub> <br>
...
<sub><b style="font-size:25px">Hosting/SaaS</b></sub> <br>
...
<sub><b style="font-size:25px">FRAMEWORKS, PLATFORMS & LIBRARIES</b></sub> <br>
